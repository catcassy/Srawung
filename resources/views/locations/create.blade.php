@extends('layouts.app')
@section('title','Tambah Hidden Gem — Srawung')
@section('content')
...
<div class="max-w-lg mx-auto px-4 py-6">
  <form action="{{ route('lokasi.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
    ...
    <div>
      ...
      <input type="text" name="alamat" value="{{ old('alamat') }}" required maxlength="200"
    ...
    <div>
      ...
      <textarea name="deskripsi" rows="3" maxlength="600"
                ...
                placeholder="Ceritakan kenapa tempat ini istimewa...">{{ old('deskripsi') }}</textarea>
    </div>
    @if($errors->any())
